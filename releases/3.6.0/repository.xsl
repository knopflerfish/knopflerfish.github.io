...
<xsl:template match="/">
  <html>
	...
	<div id="header">
	  <div id="header_logo">
	    <a href="docs/index.html"><img src="docs/images/kf300_black.png" border="0" alt="knopflerfish OSGi logo"/></a>
	  </div>
	...
	<div id="mainblock_obr">
	  ...
	  <p>
	    The repository URL is <a href="http://www.knopflerfish.org/releases/3.6.0/repository.xml">http://www.knopflerfish.org/releases/3.6.0/repository.xml</a>.
	  </p>

	  <p>
	    You can find a <a href="http://bundles.osgi.org/rfc-0112_BundleRepository.pdf">RFC-0112</a> compatible repository at <a href="http://www.knopflerfish.org/releases/3.6.0/bindex.xml">http://www.knopflerfish.org/releases/3.6.0/bindex.xml</a>.
	  </p>
