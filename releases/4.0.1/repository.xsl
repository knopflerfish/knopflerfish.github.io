...
<xsl:template match="/">
  <html>
	...
	<div id="mainblock_obr">
	  ...
	  <p>
	    The repository URL is <a href="http://www.knopflerfish.org/releases/4.0.1/repository.xml">http://www.knopflerfish.org/releases/4.0.1/repository.xml</a>.
	  </p>

	  <p>
	    You can find a <a href="http://bundles.osgi.org/rfc-0112_BundleRepository.pdf">RFC-0112</a> compatible repository at <a href="http://www.knopflerfish.org/releases/4.0.1/bindex.xml">http://www.knopflerfish.org/releases/4.0.1/bindex.xml</a>.
	  </p>
